...
export const PROJECTS = [
  {
    ...
    description:
      "I created this app because I'm passionate about movies, so I combined something practical with something I love. It allows me to keep track of the films I watch and monitor my viewing history. The application is still a work in progress. This is just the first, more basic version. See the technical details for further information. ",
