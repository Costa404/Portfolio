export const HERO_CONTENT = `I'm a passionate 𝐉𝐮𝐧𝐢𝐨𝐫 𝐖𝐞𝐛 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 focused on building visually engaging and scalable web applications. With a foundation in modern Frontend technologies like 𝐉𝐚𝐯𝐚𝐒𝐜𝐫𝐢𝐩𝐭, 𝐑𝐞𝐚𝐜𝐭𝐉𝐒, and 𝐓𝐲𝐩𝐞𝐒𝐜𝐫𝐢𝐩𝐭, I also have experience working with 𝐁𝐚𝐜𝐤𝐞𝐧𝐝 tools such as 𝐍𝐨𝐝𝐞.𝐣𝐬, 𝐌𝐨𝐧𝐠𝐨𝐃𝐁 𝐏𝐨𝐬𝐭𝐠𝐫𝐞𝐒𝐐𝐋 and 𝐅𝐢𝐫𝐞𝐛𝐚𝐬𝐞. I’m driven to leverage my skills to create innovative solutions that enhance user experience and support business growth. Excited to keep growing my expertise and make a meaningful impact through my work! 🚀`;
